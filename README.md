...
Para correr el frontend fuera de Docker (`cd frontend && npm run dev`) apuntando a un backend en otro host/puerto, configurar `VITE_API_BASE_URL` (ver `frontend/.env.example`); por defecto usa `http://localhost:8000`.
