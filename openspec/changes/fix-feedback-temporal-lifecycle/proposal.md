# Predicción sin target futuro y recalibración con trazabilidad temporal

## Trazabilidad

HU5/HU6, CRISP-DM: preparación, modelado, evaluación e integración experimental.
...
Archivos: src/human_feedback; backend/app.
