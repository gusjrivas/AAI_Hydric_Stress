# Tareas de sc-07-aux-regression
...
- [ ] T21 (SC-GOV-021) Regresión condicional. Comprobar: Revisión claims-assessment y fixtures específicos del diseño auxiliary_soil_regression_v1 antes de cualquier ejecución. Evidencia: auxiliary/R/review.json.
...
**Qué sí ocurrió.** La decisión de suficiencia GD-12 clasificó **R como
...
verbatim en `reviews/`. El artefacto `auxiliary/R/review.json` existe y vive en
`openspec/scientific-closure/sufficiency-review-2026-09-22/`.

**Consecuencia sobre cada casilla:**

- **T21 (SC-GOV-021)** — el requisito pasó a **`NOT_APPLICABLE`** en
...
**Lo que este expediente NO acredita:** ninguna ejecución de R, ningún
resultado sobre regresión, ningún desbloqueo de
