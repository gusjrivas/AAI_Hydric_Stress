...
### Requirement: sc-08-aux-hitl evidencia verificable del cambio

El sistema SHALL ejecutar sc-08-aux-hitl únicamente con dependencias satisfechas,
aprobación de alcance y autorización científica separada cuando corresponda.
Aplica SC-GOV-022 de la capacidad scientific-closure.
...
- **THEN** el auditor verifica Necesidad H=REQUIRED anterior a ejecución, diseño congelado respetado, fixtures aprobados y evidencia auditada. Si NOT_REQUIRED: solo decisión motivada, sin implementación.
