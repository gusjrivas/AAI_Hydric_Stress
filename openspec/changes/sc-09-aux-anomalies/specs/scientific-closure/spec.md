...
### Requirement: sc-09-aux-anomalies evidencia verificable del cambio

El sistema SHALL ejecutar sc-09-aux-anomalies únicamente con dependencias satisfechas,
aprobación de alcance y autorización científica separada cuando corresponda.
Aplica SC-GOV-023 de la capacidad scientific-closure.
...
- **THEN** el auditor verifica Necesidad N=REQUIRED anterior a ejecución, diseño congelado respetado, fixtures aprobados y evidencia auditada. Si NOT_REQUIRED: solo decisión motivada, sin implementación.
