...
Las cadenas de Scopus e IEEE Xplore ya se ejecutaron para los 4 ejes (registro real en `docs/research/hu1-registro-busquedas.csv`, exports en `docs/research/exports/`, consolidado en `docs/research/hu1-corpus-final.csv`). Web of Science y AGRIS siguen sin ejecutarse (bloqueos de acceso/herramienta documentados en `docs/research/hu1-registro-busquedas.csv`). SciELO y Horticultura Argentina no tienen todavía una ejecución sistemática por los 4 ejes bajo este protocolo, aunque sí cuentan con una búsqueda dirigida regional previa acotada al eje 1 (`docs/research/hu1-antecedentes-argentina.md`). Este documento queda listo para que, en cuanto haya acceso institucional a Web of Science (y/o navegación manual disponible para AGRIS), esa ejecución y registro sean mecánicos y trazables por eje.
