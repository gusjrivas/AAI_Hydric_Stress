...
```powershell
docker @DockerCommon --mount "type=bind,source=$RuntimeRoot\evidence\A,target=/runtime/evidence/A,readonly" $ImageId python -m experiment_runner.controlled_daily_v4 --stage B @Inputs --producer-dir /runtime/evidence/A --output-dir /runtime/evidence/B --stage-b-registry-path /runtime/ledger/stage_b.sqlite
