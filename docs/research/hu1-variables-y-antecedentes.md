...
| Índices de vegetación (NDVI y derivados) | Agronómica | Parámetro fisiológico no destructivo correlacionado con estrés hídrico, mencionado como alternativa a mediciones destructivas de potencial hídrico. Ver review de Sensors 2024 (arriba) | Opcional |
| Conductancia estomática / potencial hídrico foliar | Agronómica | Parámetros fisiológicos de referencia, pero de medición destructiva/costosa — motivan el uso de proxies no destructivos (SMC, térmico, NDVI). Ver review de Sensors 2024 (arriba) | Opcional (referencia/validación, no para ingesta rutinaria) |
...
| Humedad relativa | Climática | Variable meteorológica estándar, insumo directo de evapotranspiración de referencia (ET0). Ver misma referencia | Obligatoria |
| Precipitación | Climática | Determina aportes de agua al suelo; variable estándar en balance hídrico. Ver misma referencia | Obligatoria |
| Radiación solar | Climática | Insumo de ET0 (Penman-Monteith) y de estimación de demanda hídrica. Ver misma referencia | Obligatoria |
| Velocidad del viento | Climática | Insumo de ET0 (Penman-Monteith). Ver misma referencia | Obligatoria |
| Evapotranspiración de referencia (ET0) | Climática (derivada) | Síntesis de las variables meteorológicas anteriores; usada como variable derivada en modelos de manejo hídrico agrícola. Ver misma referencia | Obligatoria (puede calcularse en preprocesamiento en lugar de ingerirse directamente) |
