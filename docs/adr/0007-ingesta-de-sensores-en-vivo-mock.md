...
- `et0` sigue sin generarse por el mock; su derivación queda pendiente para una iteración futura, igual que para las fuentes reales (limitación preexistente, no introducida por este cambio).
