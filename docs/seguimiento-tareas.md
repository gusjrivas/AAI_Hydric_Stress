...
**Fuera de alcance, documentado para la próxima iteración**: ingesta de datos de sensores en vivo, robustez ante escasez/ruido en producción (ver `openspec/changes/add-alerting-ui/proposal.md`, "Fuera de alcance de este change").
