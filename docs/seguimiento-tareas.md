...
**Fuera de alcance, documentado para la próxima iteración**: motor de selección/ensamble entre varios modelos, ingesta de datos de sensores en vivo, robustez ante escasez/ruido en producción (ver `openspec/changes/add-alerting-ui/proposal.md`, "Fuera de alcance de este change").
