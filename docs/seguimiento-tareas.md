...
| Relevar datos disponibles en SMN, NASA POWER y Copernicus | 🟡 | Documentado en `docs/research/hu2-fuentes-datos-acceso.md`; **NASA POWER** tiene conector implementado, testeado y ahora **con descarga real ejecutada** (365 días, La Plata, 2025); **SMN** solo identificado, sin conector; **Copernicus** bloqueado por falta de registro del responsable del proyecto. |
